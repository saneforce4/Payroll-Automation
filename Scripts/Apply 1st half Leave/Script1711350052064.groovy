...
def Data = TestDataFactory.findTestData('Apply 1st Half Leave')
...
for (int i = 1; i <= Data.getRowNumbers(); i++) {
	...
	WebUI.selectOptionByValue(findTestObject('Object Repository/Leave/Page_2GrowHr - Attendance/select_1 Half2 Half'), '1',true)
