...
def Data = TestDataFactory.findTestData('Apply 2nd Half Leave')
...
for (int i = 1; i <= Data.getRowNumbers(); i++) {
	...
	WebUI.selectOptionByValue(findTestObject('Object Repository/Leave/Page_2GrowHr - Attendance/select_Full DayHalf Day'), 'Half Day',true)
	
	WebUI.selectOptionByValue(findTestObject('Object Repository/Leave/Page_2GrowHr - Attendance/select_1 Half2 Half'), '2',true)
	...
	WebUI.scrollToElement(findTestObject('Object Repository/Leave/Page_2GrowHr - Attendance/textarea__Reason'), 10)
