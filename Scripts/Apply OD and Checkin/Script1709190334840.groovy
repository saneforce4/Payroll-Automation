...
def Data = TestDataFactory.findTestData('Apply OD and Checkin')
...
for (int i = 1; i <= Data.getRowNumbers(); i++) {
    ...
    def ODRemark = Data.getValue('ODRemark', i)
    ...
    WebUI.click(findTestObject('Object Repository/Page_2GrowHr - Dashboard/On Duty button'))

    WebUI.click(findTestObject('Object Repository/Page_2GrowHr - Dashboard/OD date selection'))

    WebUI.setText(findTestObject('Object Repository/Page_2GrowHr - Dashboard/OD date selection'), currentDateStr)

	WebUI.click(findTestObject('Object Repository/Page_2GrowHr - Dashboard/img__img-fluid week_calender_icon dp_align_OD'))
	
	WebUI.setText(findTestObject('Object Repository/Page_2GrowHr - Dashboard/OD Remarks'),ODRemark)

    delay(2)

	WebUI.click(findTestObject('Object Repository/Page_2GrowHr - Dashboard/OD Save button'))
