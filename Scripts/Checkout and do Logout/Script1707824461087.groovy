...
def Data = TestDataFactory.findTestData('Checkout and do logout')
...
for (int i = 1; i <= Data.getRowNumbers(); i++) 
	...
	WebUI.setText(findTestObject('Object Repository/Page_2GrowHr - Dashboard/Checkout Remarks'), checkoutRemark)
